...
from builder_refined import build_edges_refined
from verifier_refined import verify_graph

def run(m=6,L=16,w=1, alpha1=9, alpha2=-7, prune_committed=True):
    states, edges, W = build_edges_refined(m,L,w,alpha1,alpha2,
    ...
    print("=== Refined (committed prune = {}) ===".format(prune_committed))
