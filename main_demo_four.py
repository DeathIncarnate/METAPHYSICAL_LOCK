...
from builder_refined4 import build_edges_refined4
from verifier_refined import verify_graph

def run(m=6,L=16,w=1, alpha1=9, alpha2=-7, prune_committed=True):
    states, edges, W = build_edges_refined4(m,L,w,alpha1,alpha2,
    ...
    print("=== Refined-4 (committed prune = {}) ===".format(prune_committed))
